...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function cm(s,e,t){const n=new Float32Array(Jn),i=new D(0,1,0);return new Pn({name:"SphericalGaussianBlur",defines:{n:Jn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:lr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Sc(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:lr(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function yc(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:lr(),fragmentShader:`
...
#define LOW_PRECISION`),e}function b0(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Kc?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Yl?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function S0(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case wi:case Ri:e="ENVMAP_TYPE_CUBE";break;case or:e="ENVMAP_TYPE_CUBE_UV";break}return e}function y0(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ri:e="ENVMAP_MODE_REFRACTION";break}return e}function T0(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Zc:e="ENVMAP_BLENDING_MULTIPLY";break;case dh:e="ENVMAP_BLENDING_MIX";break;case fh:e="ENVMAP_BLENDING_ADD";break}return e}function E0(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function A0(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=b0(t),l=S0(t),h=y0(t),u=T0(t),d=E0(t),p=f0(t),x=p0(r),_=i.createProgram();let m,f,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const S=T+m+a,A=T+f+o,C=Lc(i,i.VERTEX_SHADER,S),E=Lc(i,i.FRAGMENT_SHADER,A);i.attachShader(_,C),i.attachShader(_,E),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function P(L){if(s.debug.checkShaderErrors){const z=i.getProgramInfoLog(_)||"",V=i.getShaderInfoLog(C)||"",Y=i.getShaderInfoLog(E)||"",W=z.trim(),j=V.trim(),J=Y.trim();let H=!0,ne=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(H=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,C,E);else{const re=Ic(i,C,"vertex"),Se=Ic(i,E,"fragment");ke("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
